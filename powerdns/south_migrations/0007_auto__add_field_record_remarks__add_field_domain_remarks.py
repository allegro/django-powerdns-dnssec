...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Record.remarks'
        db.add_column(u'records', 'remarks',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Domain.remarks'
        db.add_column(u'domains', 'remarks',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Record.remarks'
        db.delete_column(u'records', 'remarks')

        # Deleting field 'Domain.remarks'
        db.delete_column(u'domains', 'remarks')
    ...
    models = {
        ...
        u'powerdns.record': {
            ...
            'auth': ('django.db.models.fields.NullBooleanField', [], {'default': 'True', 'null': 'True', 'blank': 'True'}),
