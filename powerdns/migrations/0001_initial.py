    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='date created')),
                ('modified', models.DateTimeField(auto_now=True, verbose_name='last modified', auto_now_add=True)),
                ('name', models.CharField(validators=[powerdns.models.validate_dns_nodot], max_length=255, blank=True, help_text="Actual name of a record. Must not end in a '.' and be fully qualified - it is not relative to the name of the domain!", null=True, verbose_name='name')),
                ...
                ('content', models.CharField(validators=[powerdns.models.validate_dns_nodot], max_length=255, blank=True, help_text="The 'right hand side' of a DNS record. For an A record, this is the IP address", null=True, verbose_name='content')),
